      ...
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden mb-6">
        ...
        <div className="px-6 pb-6">
          <div className="flex items-end justify-between -mt-12 mb-4">
            ...
            >
              <MessageCircle size={16} /> Написати
            </Link>
          </div>
          ...
          <p className="text-indigo-600 font-medium mt-0.5">
            {profile.role === 'job_seeker' ? 'Шукач роботи' : profile.role === 'employer' ? 'Роботодавець' : 'Адміністратор'}
          </p>
          ...
          {profile.summary && (
            <p className="text-gray-600 mt-4 leading-relaxed">{profile.summary}</p>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          {resume.portfolio && resume.portfolio.length > 0 && (
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-100">
                <h3 className="font-semibold text-gray-900">Портфоліо</h3>
              </div>
